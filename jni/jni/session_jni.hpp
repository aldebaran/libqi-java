...
extern "C"
{
  ...
  JNIEXPORT jobject JNICALL Java_com_aldebaran_qi_Session_qiSessionConnect(JNIEnv *env, jobject obj, jlong pSession, jstring jurl);
  JNIEXPORT jobject JNICALL Java_com_aldebaran_qi_Session_qiSessionClose(JNIEnv *env, jobject obj, jlong pSession);
  JNIEXPORT jobject JNICALL Java_com_aldebaran_qi_Session_service(JNIEnv* env, jobject obj, jlong pSession, jstring jname);
  ...
  JNIEXPORT jobject JNICALL Java_com_aldebaran_qi_Session_unregisterService(JNIEnv *env, jobject obj, jlong pSession, jint serviceId);
